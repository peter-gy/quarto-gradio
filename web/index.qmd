...
::: {.callout-tip}
Please keep in mind that the guides focus specifically on usage and customization of the `quarto-gradio` extension. While efforts are made to keep things as simple as possible, familiarity with Quarto, Python, Gradio and - to a certain extent - [![pyodide-logo](public/pyodide-logo.png){width=24} Pyodide](https://github.com/pyodide/pyodide){target=_blank} will definitely not hurt.
:::
